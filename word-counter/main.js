"use strict";
// Declaring variables to select various elements from the HTML document
var input = document.querySelectorAll('textarea')[0], // Selecting the input textarea
  characterCount = document.querySelector('#characterCount'), // Selecting the element to display character count
  wordCount = document.querySelector('#wordCount'), // Selecting the element to display word count
  sentenceCount = document.querySelector('#sentenceCount'), // Selecting the element to display sentence count
  paragraphCount = document.querySelector('#paragraphCount'), // Selecting the element to display paragraph count
  keywordsDiv = document.querySelectorAll('.keywords')[0], // Selecting the element to display top keywords
  topKeywords = document.querySelector('#topKeywords'); // Selecting the container for top keywords
...
input.addEventListener('keyup', function() {
  ...
  // Character count: displaying the input length as everything is a character
